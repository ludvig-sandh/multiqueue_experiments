...
python3 tools/result_plotter.py athena_results/scalability/scalability_brock400_4.csv --heatmap-width compact --value efficiency
...
python3 tools/result_plotter.py athena_results/scalability/scalability_brock400_4.csv --heatmap-width compact --value work-amplification
